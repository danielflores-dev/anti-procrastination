...
const createStyles = (theme: SchoolTheme) => StyleSheet.create({
  ...
  kicker: { color: theme.primary, fontSize: 12, fontWeight: '600', letterSpacing: 0, marginBottom: 5 },
  heading: { fontSize: 24, fontWeight: '600', color: theme.text, marginBottom: 4 },
  headingSub: { color: theme.muted, fontSize: 13, fontWeight: '600', marginBottom: 18, lineHeight: 18 },
  plannerStrip: { display: 'none' },
  plannerLabel: { color: theme.muted, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', marginBottom: 3 },
  plannerValue: { color: theme.text, fontSize: 15, fontWeight: '600' },
  ...
  emptyScheduleTitle: { color: theme.text, fontSize: 18, fontWeight: '600', marginBottom: 5 },
  emptyScheduleText: { color: theme.muted, fontSize: 14, lineHeight: 20, fontWeight: '600' },
  emptyScheduleActions: { gap: 10 },
  scheduleAction: { minHeight: 50, flex: 1, justifyContent: 'center', backgroundColor: theme.primary, borderRadius: 9, paddingVertical: 14, alignItems: 'center', shadowColor: theme.primary, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0, shadowRadius: 0, elevation: 0 },
  scheduleActionText: { color: theme.onPrimary, fontSize: 14, fontWeight: '600' },
  scheduleActionSecondary: { minHeight: 50, flex: 1, justifyContent: 'center', backgroundColor: theme.surface, borderRadius: 9, borderWidth: 1, borderColor: theme.border, paddingVertical: 14, alignItems: 'center' },
  scheduleActionSecondaryText: { color: theme.text, fontSize: 14, fontWeight: '600' },
  ...
  monthTitle: { fontSize: 18, fontWeight: '600', color: theme.text },
  ...
  dayPanelTitle: { color: theme.text, fontSize: 17, fontWeight: '600', marginBottom: 12 },
  dayPanelSection: {
  ...
  scheduleItemTitle: { color: theme.text, fontSize: 16, fontWeight: '600', marginBottom: 4 },
  ...
  focusBtnText: { color: theme.onPrimary, fontSize: 14, fontWeight: '600' },
  deleteBtn: { paddingHorizontal: 14, borderRadius: 8, borderWidth: 1, borderColor: '#EF4444', paddingVertical: 12, alignItems: 'center' },
