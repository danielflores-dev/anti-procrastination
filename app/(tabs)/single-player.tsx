...
const createStyles = (theme: SchoolTheme) => StyleSheet.create({
  ...
  focusButtonText: { color: theme.onPrimary, fontSize: 14, fontWeight: '600' },
  progressButton: { borderRadius: 8, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surfaceAlt, paddingHorizontal: 12, paddingVertical: 13 },
  progressButtonText: { fontSize: 12, fontWeight: '600' },
  ...
  autoBtnText: { color: theme.text, fontSize: 14, fontWeight: '600' },
